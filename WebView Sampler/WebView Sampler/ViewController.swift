...
class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
	...
	let sampleOptions = [
		...
		HTMLSample(description: "Bar Chart (pushed TSV)", URLString: "barchartPushedTSV", isFile: true, filenameExtension: "html",
            dataString: barchartJSONString, dataVariable: "barsData", javaScriptFunction: "refresh"),
		...
		HTMLSample(description: "Simple Data Push", URLString: "simpleD3Push", isFile: true, filenameExtension: "html",
			dataString: streamgraphCSVString, dataVariable: "barsData", javaScriptFunction: "refresh"),
