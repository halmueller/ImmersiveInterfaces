...
class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
	...
	let sampleOptions = [
		...
		HTMLSample(description: "Bar Chart (pushed TSV)", URLString: "barchartExternalTSV", isFile: true, filenameExtension: "html",
			dataString: barchartJSONString),
		...
		HTMLSample(description: "Simple Data Push", URLString: "simpleD3Push", isFile: true, filenameExtension: "html",
			dataString: streamgraphCSVString),
